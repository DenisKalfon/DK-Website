                ...
                <div class="responsive-carousel">
                    <div>
                        ...
                        <div class="legend col-xs-12">
                            ...
                            <a data-toggle="modal" data-target="#a1" class="text-center"><i class="fa fa-search"></i>&nbsp;Aperçu</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="legend col-xs-12">
                            ...
                            <p>HTML - CSS - jQuery</p>
                            <a data-toggle="modal" data-target="#a2" class="text-center"><i class="fa fa-search"></i>&nbsp;Aperçu</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="legend col-xs-12">
                            ...
                            <a data-toggle="modal" data-target="#a3" class="text-center"><i class="fa fa-search"></i>&nbsp;Aperçu</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="legend col-xs-12">
                            ...
                            <a data-toggle="modal" data-target="#a4" class="text-center"><i class="fa fa-search"></i>&nbsp;Aperçu</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="legend col-xs-12">
                            ...
                            <p>PHP5 - Joomla</p>
                            <a data-toggle="modal" data-target="#a5" class="text-center"><i class="fa fa-search"></i>Aperçu</a>
                        </div>
                    </div>
                </div>
            </div>
